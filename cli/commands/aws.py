"""AWS cost commands for CloudSathi CLI."""
...
app = typer.Typer(help="AWS cost management commands")
config = Config()
...
def get_costs(
    ...
    print_info(f"Fetching AWS costs from {start_date} to {end_date}...")
    ...
    try:
        # Fetch costs
        data = client.get_aws_costs(start_date, end_date)
        
        # Display results
        if output_format == "json":
            display_json(data)
        else:
            display_aws_costs(data)
